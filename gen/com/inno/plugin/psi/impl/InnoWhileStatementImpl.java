...
public class InnoWhileStatementImpl extends ASTWrapperPsiElement implements InnoWhileStatement {

  public InnoWhileStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public InnoCondition getCondition() {
    return findNotNullChildByClass(InnoCondition.class);
  }
